...
public class MenController implements Initializable {
    ...
    Button mcartbutton, mcartbutton1, mcartbutton2, mcartbutton3, mcartbutton4, mcartbutton5, mcartbutton6,
            mfavbutton, mfavbutton1, mfavbutton2, mfavbutton3, mfavbutton4, mfavbutton5,mfavbutton6,
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        switch (imageView.getId()) {
            case "mimg1":
                ...
                pname = HomeController.mclshirt.getProductName();
                pprice = HomeController.mclshirt.getProductPrice();
                break;
            case "mimg2":
                desc = HomeController.mcvest.getProductDescription();
                pname = HomeController.mcvest.getProductName();
                pprice = HomeController.mcvest.getProductPrice();
                break;
            case "mimg3":
                desc = HomeController.mkcoverup.getProductDescription();
                pname = HomeController.mkcoverup.getProductName();
                pprice = HomeController.mkcoverup.getProductPrice();
                break;
            case "mimg4":
                desc = HomeController.mdshorts.getProductDescription();
                pname = HomeController.mdshorts.getProductName();
                pprice = HomeController.mdshorts.getProductPrice();
                break;
            case "mimg5":
                desc = HomeController.mkjshorts.getProductDescription();
                pname = HomeController.mkjshorts.getProductName();
                pprice = HomeController.mkjshorts.getProductPrice();
                break;
            case "mimg6":
                desc = HomeController.mcwshirt.getProductDescription();
                pname = HomeController.mcwshirt.getProductName();
                pprice = HomeController.mcwshirt.getProductPrice();
        }
    ...
    public void addtoFavorites(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(mfavbutton1)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane1);

        } 

        else if (sourceButton.equals(mfavbutton2)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane2);
            
        }
        else if (sourceButton.equals(mfavbutton3)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane3);
        
        }
        else if (sourceButton.equals(mfavbutton4)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane4);
            
        }
        else if (sourceButton.equals(mfavbutton5)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane5);
            
        }
        else if (sourceButton.equals(mfavbutton6)) {
            HomeController.favorites.addItem(HomeController.favoritesController.mpane6);
