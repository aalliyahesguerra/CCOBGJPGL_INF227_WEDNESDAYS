...
public class WomenController implements Initializable {
    ...
    @FXML
    Pane wpane1, wpane2, wpane3, wpane4, wpane5, wpane6;

    @FXML
    Button wcartbutton, wcartbutton1, wcartbutton2, wcartbutton3, wcartbutton4, wcartbutton5, wcartbutton6,
        wfavbutton, wfavbutton1, wfavbutton2, wfavbutton3, wfavbutton4, wfavbutton5,wfavbutton6,
        profileButton, wednesdaysbutton;
    ...
    public void addtoFavorites(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(wfavbutton1)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane1);

        } 

        else if (sourceButton.equals(wfavbutton2)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane2);
            
        }
        else if (sourceButton.equals(wfavbutton3)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane3);
        
        }
        else if (sourceButton.equals(wfavbutton4)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane4);
            
        }
        else if (sourceButton.equals(wfavbutton5)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane5);
            
        }
        else if (sourceButton.equals(wfavbutton6)) {
            HomeController.favorites.addItem(HomeController.favoritesController.wpane6);
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        switch (imageView.getId()) {
            case "wimg1":
                ...
                pname = HomeController.wlshort.getProductName();
                pprice = HomeController.wlshort.getProductPrice();
                break;
            case "wimg2":
                desc = HomeController.waskort.getProductDescription();
                pname = HomeController.waskort.getProductName();
                pprice = HomeController.waskort.getProductPrice();
                break;
            case "wimg3":
                desc = HomeController.wbjacket.getProductDescription();
                pname = HomeController.wbjacket.getProductName();
                pprice = HomeController.wbjacket.getProductPrice();
                break;
            case "wimg4":
                desc = HomeController.wcblazer.getProductDescription();
                pname = HomeController.wcblazer.getProductName();
                pprice = HomeController.wcblazer.getProductPrice();
                break;
            case "wimg5":
                desc = HomeController.wptrousers.getProductDescription();
                pname = HomeController.wptrousers.getProductName();
                pprice = HomeController.wptrousers.getProductPrice();
                break;
            case "wimg6":
                desc = HomeController.wpdress.getProductDescription();
                pname = HomeController.wpdress.getProductName();
                pprice = HomeController.wpdress.getProductPrice();
        }
