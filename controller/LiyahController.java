...
public class LiyahController implements Initializable {
    ...
    @FXML
    Pane lpane1, lpane2, lpane3, lpane4, lpane5, mpane6;
    ...
    Button lcartbutton, lcartbutton1, lcartbutton2, lcartbutton3, lcartbutton4, lcartbutton5,
            lfavbutton, lfavbutton1, lfavbutton2, lfavbutton3, lfavbutton4, lfavbutton5,
    ...
    public void buy(ActionEvent event) throws IOException {
     ...
     public void addtoFavorites(ActionEvent event) throws IOException {
        ...
        // If addtocart button is pressed, set product status to true
        if (sourceButton.equals(lfavbutton1)) {
            HomeController.favorites.addItem(HomeController.favoritesController.lpane1);
        } 
       
        else if (sourceButton.equals(lfavbutton2)) {
            HomeController.favorites.addItem(HomeController.favoritesController.lpane2);
        } 
        else if (sourceButton.equals(lfavbutton3)) {
            HomeController.favorites.addItem(HomeController.favoritesController.lpane3);
        } 
        else if (sourceButton.equals(lfavbutton4)) {
            HomeController.favorites.addItem(HomeController.favoritesController.lpane4);
        } 
        else if (sourceButton.equals(lfavbutton5)) {
            HomeController.favorites.addItem(HomeController.favoritesController.lpane4);
        } 
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        switch (imageView.getId()) {
            case "limg1":
                ...
                pname = HomeController.lbpants.getProductName();
                pprice = HomeController.lbpants.getProductPrice();
                break;
            case "limg2":
                desc = HomeController.lpshorts.getProductDescription();
                pname = HomeController.lpshorts.getProductName();
                pprice = HomeController.lpshorts.getProductPrice();
                break;
            case "limg3":
                desc = HomeController.lljacket.getProductDescription();
                pname = HomeController.lljacket.getProductName();
                pprice = HomeController.lljacket.getProductPrice();
                break;
            case "limg4":
                desc = HomeController.lglasses.getProductDescription();
                pname = HomeController.lglasses.getProductName();
                pprice = HomeController.lglasses.getProductPrice();
                break;
            case "limg5":
                desc = HomeController.lvest.getProductDescription();
                pname = HomeController.lvest.getProductName();
                pprice = HomeController.lvest.getProductPrice();
                break;
        }
