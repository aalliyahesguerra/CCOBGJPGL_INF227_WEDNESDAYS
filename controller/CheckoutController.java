...
public class CheckoutController implements Initializable {
    ...
    @FXML
    Button backbutton, favbutton, checkoutbutton;
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.bwshort.getProductStatus()) {
            ...
            bitem3Amount = HomeController.bwshort.getProductPrice() * qty;
        ...
        if (HomeController.bstop.getProductStatus()) {
            ...
            bitem4Amount = HomeController.bstop.getProductPrice() * qty;
        ...
        if (HomeController.bsunglasses.getProductStatus()) {
            ...
            bitem5Amount = HomeController.bsunglasses.getProductPrice() * qty;
        ...
        if (HomeController.mcvest.getProductStatus()) {
            totalAmount += HomeController.mcvest.getProductPrice();
        }
        if (HomeController.mkcoverup.getProductStatus()) {
        ...
        if (HomeController.bwshort.getProductStatus()) {
            totalAmount += HomeController.bwshort.getProductPrice();
        }
        if (HomeController.bstop.getProductStatus()) {
        ...
        if (HomeController.bsunglasses.getProductStatus()) {
            totalAmount += BiaController.bsunglasses.getProductPrice();
        }
        // ======liyah=====//
    ...
    public void checkout(ActionEvent event) throws IOException {
        ...
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/rcpt.fxml"));
        Parent root = loader.load();
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
